...
After looking around the code for a while, we quickly realized that we needed to create a new material in the material list within the basic-sphere scene, and change the sphere radius and color in that same scene. 
