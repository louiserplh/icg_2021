...
public class TilesDB {
    ...
    public TilesDB() {
        ...
        Tile t6 = new Tile("tile_1_left_nb", -1, -1, 3, -1, -1, 6, -1);
        ...
        Tile t9 = new Tile("tile_1_left_nr_corner", -3, 4, 4, -3, 13, 0, 0);
        Tile t9_90 = new Tile("tile_1_left_nr_corner_90", -3, 4, -3, 4, 14, 0, 2);

        Tile t10 = new Tile("tile_1_middle", -3, -3, 2, 2, -1, 0, 0);
        Tile t10_90 = new Tile("tile_1_middle_90", 2, 2, -3, -3, -1, 0, -1);

        Tile t11 = new Tile("tile_1_middle_nb", -1, -1, 2, 2, -1, 8, -1);
        Tile t11_90 = new Tile("tile_1_middle_nb_90", 2, 2, -1, -1, -1, 12, -1);
        ...
        Tile t14 = new Tile("tile_1_right_corner", -3, 2, -3, 2, -1, 0, 0);
        Tile t14_90 = new Tile("tile_1_right_corner_90", 2, -3, -3, 2, -1, 0, 2);

        Tile t15 = new Tile("tile_1_right_nb", -1, -1, -1, 3, -1, 7, -1);
        Tile t15_90 = new Tile("tile_1_right_nb_90", 3, -1, -1, -1, -1, 11, -1);

        Tile t16 = new Tile("tile_1_right_nb_corner", -1, 3, -1, 3, -1, 15, -1);
        Tile t16_90 = new Tile("tile_1_right_nb_corner_90", -1, 3, -1, 3, -1, 16, -1);
        ...
        Tile t19 = new Tile("tile_2_alone_nr", -1, -1, -1, -1, 1, 1, -1);

        Tile t20 = new Tile("tile_2_left_nr", -1, -1, 5, -1, 6, 6, -1);
        Tile t20_90 = new Tile("tile_2_left_nr_90", -1, 5, -1, -1, 10, 10, -1);

        Tile t21 = new Tile("tile_2_left_nr_corner", -1, 5, 5, -1, 6, 6, -1);
        Tile t21_90 = new Tile("tile_2_left_nr_corner_90", -1, 5, -1, 5, 10, 10, -1);

        Tile t22 = new Tile("tile_2_middle_nr", -1, -1, 5, 5, 8, 8, -1);
        Tile t22_90 = new Tile("tile_2_middle_nr_90", 5, 5, -1, -1, 12, 12, -1);

        Tile t23 = new Tile("tile_2_right_nr", -1, -1, -1, 5, 7, 7, -1);
        Tile t23_90 = new Tile("tile_2_right_nr_90", 5, -1, -1, -1, 11, 11, -1);

        Tile t24 = new Tile("tile_2_right_nr_corner", -1, 5, -1, 5, 7, 7, -1);
        Tile t24_90 = new Tile("tile_2_right_nr_corner_90", 5, -1, -1, 5, 11, 11, -1);

        Tile t25 = new Tile("tile_3_left", -1, -1, 5, -1, 6, 6, -1);
        Tile t25_90 = new Tile("tile_3_left_90", -1, 5, -1, -1, 10, 10, -1);

        Tile t26 = new Tile("tile_3_left_fancy", -1, -1, 3, -1, -1, 6, -1);
        Tile t26_90 = new Tile("tile_3_left_fancy_90", -1, 3, -1, -1, -1, 10, -1);

        Tile t27 = new Tile("tile_3_left_nr", -1, -1, 5, -1, -1, 6, -1);
        Tile t27_90 = new Tile("tile_3_left_nr_90", -1, 5, -1, -1, -1, 10, -1);

        Tile t28 = new Tile("tile_3_middle", -1, -1, 5, 5, 8, 8, -1);
        Tile t28_90 = new Tile("tile_3_middle_90", 5, 5, -1, -1, 12, 12, -1);

        Tile t29 = new Tile("tile_3_middle_fancy", -1, -1, 3, 3, 8, 8, -1);
        Tile t29_90 = new Tile("tile_3_middle_fancy_90", 3, 3, -1, -1, 12, 12, -1);

        Tile t30 = new Tile("tile_3_middle_nr", -1, -1, 5, 5, -1, 8, -1);
        Tile t30_90 = new Tile("tile_3_middle_nr_90", 5, 5, -1, -1, -1, 12, -1);

        Tile t31 = new Tile("tile_3_right", -1, -1, -1, 5, 7, 7, -1);
        Tile t31_90 = new Tile("tile_3_right_90", 5, -1, -1, -1, 11, 11, -1);

        Tile t32 = new Tile("tile_3_right_fancy", -1, -1, -1, 3, -1, 7, -1);
        Tile t32_90 = new Tile("tile_3_right_fancy_90", 3, -1, -1, -1, -1, 11, -1);
