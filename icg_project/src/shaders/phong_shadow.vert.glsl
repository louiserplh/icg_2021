...
void main() {
    ...
    */
	...
	v2f_position_view = vec3(mat_model_view * (position_v4)); // TODO calculate
	// transform normal to camera coordinates
	v2f_normal = vec3(mat_normals * normal); // TODO apply normal transformation
	gl_Position = mat_mvp * position_v4; // TODO apply mvp matrix to position
